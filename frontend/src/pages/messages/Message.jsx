...
const tabs = [
  { name: "Admin", value: "1", icon: <AdminPanelSettings /> },
  { name: "Coordinator", value: "2", icon: <AccessibilityNewRounded /> },
  { name: "Faculty", value: "4", icon: <School /> },
  { name: "Scholars", value: "5", icon: <People /> },
];
...
function Messages() {
  ...
  const socket = useSocket(BASE_API_URL);
