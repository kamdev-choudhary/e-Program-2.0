    ...
    <form onSubmit={handleSubmit} noValidate className="needs-validation">
        ...
        <div className="row mt-2">
          <div className="col-md-4 mb-2">
            <div className="input-group flex-nowrap rounded border border-success">
              <span className="input-group-text bg-success text-light" id="addon-wrapping">
                Subject
              </span>
              <select
      ...
      <div className="col-12 mt-2 p-2 border rounded">
        ...
        <div className="input-group">
          <span className="input-group-text bg-success text-light">Answer Key</span>
          <input
        ...
        <hr />
        <div className="input-group">
          <span className="input-group-text bg-success text-light">Solution</span>
          <textarea
            className="form-control"
            rows="3"
            aria-label="Solution"
