...
export default function ViewExamTemplate(props) {
  ...
  const handleAddToBatchInput = (e) => {
    if (e.target.name === 'batchName') {
      ...
      const selectedBatch = batches.find((batch) => batch.batchName === selectedBatchName)
    ...
    <>
      ...
      <div className="row d-flex text-end mb-2 ">
        <div className="col-md-12 ">
          <Fab size="small" color="primary" aria-label="add" onClick={handleShowAddExamToBatch}>
            <AddIcon />
          </Fab>
        </div>
      </div>
                  ...
                  <Grid item xs={12} md={11} lg={11}>
                    ...
                    >
                      <Grid item container xs="auto" alignItems="baseline">
                        <Grid item>({question.option1.isCorrect ? '*' : ''}A) </Grid>
                        <Grid item>
                          <Typography
                            dangerouslySetInnerHTML={{
                      ...
                      <Grid item container xs="auto" alignItems="baseline">
                        <Grid item>({question.option2.isCorrect ? '*' : ''}B) </Grid>
                        <Grid item>
                          <Typography
                            dangerouslySetInnerHTML={{
                      ...
                      <Grid item container xs="auto" alignItems="baseline">
                        <Grid item>({question.option3.isCorrect ? '*' : ''}C)</Grid>
                        <Grid item>
                          <Typography
                            dangerouslySetInnerHTML={{
                      ...
                      <Grid item container xs="auto" alignItems="baseline">
                        <Grid item>({question.option4.isCorrect ? '*' : ''}D) </Grid>
                        <Grid item>
                          <Typography
                            dangerouslySetInnerHTML={{
      ...
      <Modal show={ShowAddExamToBatch} onHide={handleShowAddExamToBatch} dialogClassName="modal-m">
