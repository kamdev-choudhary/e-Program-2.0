            ...
            <FormControl fullWidth size="small">
              ...
              >
                {academic && academic.classes
                  ...
                  : question.classes && (
                      <MenuItem value={question.classes}>{question.classes}</MenuItem>
                    )}
              </Select>
            </FormControl>
          </Grid>
            ...
            <FormControl fullWidth size="small">
              ...
              >
                {academic && academic.subjects
                  ...
                  : question.subject && (
                      <MenuItem value={question.subject}>{question.subject}</MenuItem>
                    )}
              </Select>
            </FormControl>
          </Grid>
            ...
            <FormControl fullWidth size="small">
              ...
              >
                {filteredTopics
                  ...
                  : question.topic && <MenuItem value={question.topic}>{question.topic}</MenuItem>}
              </Select>
            </FormControl>
          </Grid>
          <Grid item xs={12} md={4} lg={3}>
              ...
              >
                {academic && academic.timeRequired
                  ...
                  : question.timeRequired && (
                      <MenuItem value={question.timeRequired}>{question.timeRequired}</MenuItem>
                    )}
              </Select>
            </FormControl>
          </Grid>
            ...
            <FormControl fullWidth size="small">
              ...
              >
                {academic && academic.target
                  ...
                  : question.target && (
                      <MenuItem value={question.target}>{question.target}</MenuItem>
                    )}
              </Select>
            </FormControl>
          </Grid>
