  ...
  useEffect(() => {
    if (filteredTopics.length > 0) {
      const filteredSubtopics = filteredTopics
        .filter((topic) => !questionData.topic || topic.name === questionData.topic)
    ...
    <>
      <Box sx={{ flexGrow: 1 }} padding={1}>
        <Grid container spacing={1}>
          <Grid item xs={12} md={4} lg={3}>
            <FormControl fullWidth size="small" error={Boolean(validationError.classes)}>
          ...
          <Grid item xs={12} md={4} lg={3}>
            <FormControl fullWidth size="small" error={Boolean(validationError.subject)}>
          ...
          <Grid item xs={12} md={4} lg={3}>
            <FormControl fullWidth size="small" error={Boolean(validationError.topic)}>
          ...
          <Grid item xs={12} md={4} lg={3}>
            <FormControl fullWidth size="small" error={Boolean(validationError.subtopic)}>
      ...
      <Box padding={1}>
        ...
        <TinyBox
          ...
          onContentChange={(newContent) => handleTinyBoxChange('questionText', newContent)}
        />
      ...
      <Box padding={1}>
        ...
        <TinyBox
          ...
          onContentChange={(newContent) => handleTinyBoxChange('solution', newContent)}
        />
