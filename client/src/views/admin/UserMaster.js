...
import StudentProfile from '../../components/UpdateStudentProfile'
      ...
      <>
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} lg={12}>
            <Skeleton sx={{ borderRadius: 2 }} variant="rectangular" height={1} />
          </Grid>
    ...
    <>
      <Grid container spacing={2}>
        ...
        <Grid item xs={6} md={2} lg={2}>
          <Button fullWidth variant="contained" color="info" sx={{ borderRadius: 10 }}>
            Add User
          </Button>
        </Grid>
      </Grid>
