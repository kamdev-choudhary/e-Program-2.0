  ...
  if (isLoading) {
    return (
      <>
        ...
        >
          <Skeleton sx={{ borderRadius: 1 }} variant="rectangular" width={180} height={40} />
          <Skeleton sx={{ borderRadius: 10 }} variant="rectangular" width={150} height={40} />
        </Box>
        <br />
        <Stack spacing={2}>
          {[...Array(5)].map((_, index) => (
        ...
        <>
          ...
          >
            <Grid container spacing={1}>
              ...
              {isAdmin || (currDoubt.postedById && currDoubt.postedById === userId) ? (
