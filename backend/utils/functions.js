...
export const generateMockData = () => {
  return {
    ...
    nationality: "Indian",
    mathematics1: faker.number.float({ min: 30, max: 100, precision: 0.01 }),
    mathematics2: faker.number.float({ min: 30, max: 100, precision: 0.01 }),
    mathematics: faker.number.float({ min: 30, max: 100, precision: 0.01 }),
    physics1: faker.number.float({ min: 30, max: 100, precision: 0.01 }),
    physics2: faker.number.float({ min: 30, max: 100, precision: 0.01 }),
    physics: faker.number.float({ min: 30, max: 100, precision: 0.01 }),
    chemistry1: faker.number.float({ min: 30, max: 100, precision: 0.01 }),
    chemistry2: faker.number.float({ min: 30, max: 100, precision: 0.01 }),
    chemistry: faker.number.float({ min: 30, max: 100, precision: 0.01 }),
    total1: faker.number.float({ min: 30, max: 100, precision: 0.01 }),
    total2: faker.number.float({ min: 30, max: 100, precision: 0.01 }),
    total: faker.number.float({ min: 30, max: 100, precision: 0.01 }),
