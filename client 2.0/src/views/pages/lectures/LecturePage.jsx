            ...
            <Box sx={addLectureStyle}>
              <Grid container spacing={2}>
                ...
                <Grid item container justifyContent="center" alignItems="center">
                  <Button onClick={handleAddNewLecture} variant="contained" color="success">
                    Save Lecture
                  </Button>
                </Grid>
              </Grid>
        ...
        <Box sx={{ marginTop: 2 }}>
          <TableContainer sx={{ maxHeight: '80vh' }}>
            <Table stickyHeader aria-label="sticky table">
              ...
              <TableBody style={{ overflowY: 'auto', maxHeight: 'calc(100vh - 200px)' }}>
                {filteredLectures &&
                ...
                <TableBody>
                  {Object.keys(lecturesByChapter).map((chapterName, index) => (
                    <React.Fragment key={index}>
                      {(index === 0 ||
                        chapterName !== Object.keys(lecturesByChapter)[index - 1]) && (
